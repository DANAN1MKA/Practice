...
//        if (File.Exists(Application.persistentDataPath + "/Storage.bin"))
//        {
//            StorageClass storage = load(Application.persistentDataPath + "/Storage.bin");


//            setupPlayerData(storage);
...
//        {
//            setupDefault();
//            FileStream file = File.Create(Application.persistentDataPath + "/Storage.bin");
//            file.Close();

//            save(getPlayerData() , Application.persistentDataPath + "/Storage.bin");
