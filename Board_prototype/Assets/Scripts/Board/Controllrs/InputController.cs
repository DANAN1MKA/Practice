                ...
                case TouchPhase.Began:
                        ...
                        posY < board.heigth && posX >= 0)
                    {
                        ...
                        if (!currentElemenet.isBlocked)
                        {
                            ...
                            //TODO: animation
                            currentElemenet.animator.StartPlayback();
                            currentElemenet.animator.Play(0);
                    ...
                    if (isExistCurrElem)
                    {
                        ...
                        if (currentDirection.x != 0 || currentDirection.y != 0)
                        {
                            ...
                            if (board.swipeElements(currentElemenet, elementTwo))
                            {
                                ...
                                //elementTwo.animator.StartPlayback();
                                //elementTwo.animator.Play(0);
                            }
                            else
                            {
                                //TODO: animation
                                currentElemenet.animator.StopPlayback();
                            }
